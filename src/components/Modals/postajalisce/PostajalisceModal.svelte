...
>
  <div on:click|stopPropagation>
    <div class="modal-header">
      <h1 style="font-size: 24px;"><i class="fas fa-info-circle"></i> Podatki o postajališču</h1>
    </div>
    <hr />
    {#if modalContent}
      <form class="modal-content">
        ...
        <div class="property">
          ...
          <input type="text" value={modalContent.name} readonly />
        </div>
        <div class="property">
          <label><i class="fas fa-location-arrow"></i> Naslov</label>
          <input type="text" value={modalContent.address} readonly />
        </div>
        <div class="property">
          <label><i class="fas fa-map-pin"></i> Latitude</label>
          <input type="text" value={modalContent.latitude} readonly />
        </div>
        <div class="property">
          <label><i class="fas fa-map-pin"></i> Longitude</label>
          <input type="text" value={modalContent.longitude} readonly />
        </div>
      </form>
    {/if}
    <hr />
