...
declare module '$env/static/private' {
	...
	export const VITE_MAPAPIKEY: string;
	export const VITE_SAPAPIURL: string;
	export const ALLUSERSPROFILE: string;
	export const AmosApp: string;
	export const AmosDocs: string;
	export const AmosExamples: string;
	export const AmosLogs: string;
	export const AmosPlugins: string;
	export const AmosProgram: string;
	export const AmosTemplates: string;
	export const AmosTutorial: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		VITE_MAPAPIKEY: string;
		VITE_SAPAPIURL: string;
